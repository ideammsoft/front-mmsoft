      ...
      <section className={styles.section}>
        <div className={styles.container}>
          ...
          <div className={styles.introText}>
            ...
            <p>
              1997년 <strong>여러사람소프트</strong>로 출발해 2005년{' '}
              <strong>(주)여러사람소프트</strong>를 거쳐, 2015년 현재의{' '}
              <strong>엠엠소프트(MMSoft)</strong>로 상호를 변경했습니다.
              이름은 바뀌었지만 같은 사업을 이어오고 있으며, 여러사람소프트 시절부터
              사용해 오신 고객사의 제품 지원과 문의도 그대로 받고 있습니다.
            </p>
            <p>
